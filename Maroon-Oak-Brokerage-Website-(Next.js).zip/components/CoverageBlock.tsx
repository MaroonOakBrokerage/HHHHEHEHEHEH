...
const productIcon: Record<string, typeof CarIcon> = {
  ...
  life: FamilyIcon,
  "valuable-items": ShieldCheckIcon,

  "general-liability": ShieldCheckIcon,
  "workers-comp": HardHatIcon,
  ...
  "builders-risk": CraneIcon,
  "inland-marine": ToolboxIcon,
  "commercial-crime": LockIcon,
  "directors-officers": HandshakeIcon,
  epli: WorkersIcon,
  "surety-bonds": CertificateIcon,
