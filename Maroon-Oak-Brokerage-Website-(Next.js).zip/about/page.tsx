      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-[820px] px-8">
          ...
          <p className="mb-4 font-sans text-[16.5px] leading-relaxed text-[#55504a]">
            ...
            Before discussing policies, coverage, or premiums, we take the time
            to understand your goals, your family, your business, and what
            matters most to you.
          </p>

          <p className="mb-4 font-sans text-[16.5px] leading-relaxed text-[#55504a]">
            Every recommendation begins with listening, because the best
            protection starts with understanding. As an independent brokerage,
            we work with multiple insurance carriers to provide customized
            insurance solutions instead of one-size-fits-all policies.
          </p>
            ...
            <div className="rounded-lg border border-stone/20 bg-stone/5 p-8">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  <li
                    key={value}
                    className="relative pl-5 font-sans text-sm text-stone/90"
                  >
      ...
      <section className="bg-stone py-24">
        <div className="mx-auto max-w-[1200px] px-8">
          ...
          <p className="mx-auto mb-14 max-w-[640px] text-center font-sans text-[17px] leading-relaxed text-[#55504a]">
            Six values that guide how we serve every client &mdash; not a poster
            on a wall. Select one to read more.
          </p>
        ...
        <div className="mx-auto max-w-[1200px] px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-lg border border-charcoal/10 bg-stone p-8">
              <h3 className="mb-2.5 font-serif text-xl font-semibold text-maroon">
                Customer-First, By Design
              </h3>

              <p className="font-sans text-sm leading-relaxed text-[#55504a]">
                Because we&rsquo;re not employed by any one carrier, we&rsquo;re
                free to recommend the coverage that actually fits your
                situation &mdash; not the option a single company&rsquo;s quota
                requires.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-charcoal/10 bg-stone p-8">
              ...
              <p className="font-sans text-sm leading-relaxed text-[#55504a]">
                ...
                transactions &mdash; the same standard we hold for how we treat
