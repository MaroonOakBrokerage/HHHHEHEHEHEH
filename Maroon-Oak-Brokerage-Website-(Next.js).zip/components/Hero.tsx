...
export default function Hero() {
  return (
    <section className="relative overflow-hidden min-h-[650px] py-20 md:py-24 lg:flex lg:min-h-[690px] lg:items-center">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(95deg,rgba(7,15,22,0.94)_0%,rgba(58,10,24,0.79)_42%,rgba(7,15,22,0.35)_100%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-8">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
          <div>
            ...
            <h1 className="max-w-[680px] font-serif text-[46px] font-medium leading-[1.02] text-stone sm:text-[60px] md:text-[76px]">
              Understanding First.
              <br />
              <span className="text-stone">Insurance Second.</span>
            </h1>
