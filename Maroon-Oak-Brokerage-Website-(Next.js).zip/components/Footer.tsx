...
export default function Footer() {
  return (
    <footer className="border-t border-gold/30 bg-[linear-gradient(110deg,#090e14,#1d0910_65%,#3a0a18)] text-stone/70 pt-[70px] pb-6">
      <div className="mx-auto max-w-[1200px] px-8">
        <div className="grid grid-cols-1 gap-10 pb-12 md:grid-cols-4">
          <div>
            ...
            <p className="mb-3 max-w-[280px] text-[13px] leading-relaxed">
              Maroon Oak Brokerage is an Aggie-founded independent insurance brokerage built on relationships,
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 border-t border-stone/10 pt-6 text-xs text-stone/45">
          <span>&copy; {new Date().getFullYear()} Maroon Oak Brokerage. Founded 2026 • Independent Insurance Brokerage. All rights reserved.</span>
